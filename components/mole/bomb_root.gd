...
@onready var appear_player = $AnimationAppearBombRoot
@onready var disappear_player = $AnimationDisappearBombRoot
@onready var sprite = $RootSprite
@onready var collision = $RootCollision
