...
@onready var appear_player = $AnimationAppearFriend
@onready var disappear_player = $AnimationDisappearFriend
@onready var sprite = $FriendSprite
@onready var collision = $FriendCollision
